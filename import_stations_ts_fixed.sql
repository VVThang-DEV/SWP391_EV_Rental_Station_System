...
-- SỬA LỖI: Xóa vehicles trước, sau đó mới xóa stations

-- ============================================
-- BƯỚC 1: XÓA DỮ LIỆU CŨ (THEO THỨ TỰ ĐÚNG)
-- ============================================

-- Xóa dữ liệu vehicles TRƯỚC (do có foreign key đến stations)
DELETE FROM vehicles;

-- Xóa dữ liệu stations SAU
