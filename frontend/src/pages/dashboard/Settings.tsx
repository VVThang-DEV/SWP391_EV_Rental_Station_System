          ...
          <TabsContent value="documents">
            <Card>
              ...
              <CardContent>
                <div className="space-y-6">
                  <p className="text-sm text-muted-foreground">
                    Cập nhật CMND/CCCD và Bằng lái xe của bạn. Tài liệu rõ nét, đầy đủ 4 góc, tối đa 10MB mỗi ảnh.
                  </p>
                  <div>
                    <h3 className="text-lg font-semibold mb-4">
                      {language === "vi"
                            ...
                            <div className="mt-4">
                              <Label className="cursor-pointer">
                                ...
                                <input
                                  ...
                                  accept="image/*"
                                  onChange={(e) => {
                                    console.log("Front side file:", e.target.files?.[0]);
                                  }}
                                />
                            ...
                            <div className="mt-4">
                              <Label className="cursor-pointer">
                                ...
                                <input
                                  ...
                                  accept="image/*"
                                  onChange={(e) => {
                                    console.log("Back side file:", e.target.files?.[0]);
                                  }}
                                />
                                <span className="mt-2 block text-xs text-gray-500">
                                  {language === "vi"
