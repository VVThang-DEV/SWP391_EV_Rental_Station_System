-- Đồng bộ dữ liệu từ vehicles.ts vào database hiện có
-- KHÔNG xóa dữ liệu, chỉ cập nhật các trường còn thiếu

-- ============================================
-- CẬP NHẬT VEHICLE_MODELS VỚI DỮ LIỆU TỪ VEHICLES.TS
-- ============================================
...
-- ============================================
-- CẬP NHẬT VEHICLES VỚI DỮ LIỆU CHI TIẾT
-- ============================================
...
UPDATE vehicles SET 
    image = CASE 
        ...
        ELSE 'https://vinfastvietnam.com.vn/wp-content/uploads/2023/09/Xam-min.png'
    END,
    license_plate = CASE 
        ...
        ELSE '50A-' + CAST(vehicle_id AS VARCHAR)
    END,
...
UPDATE vehicles SET 
    image = CASE 
        ...
        ELSE 'https://vinfast-vn.vn/wp-content/uploads/2023/10/vinfast-vf5-grey.png'
    END,
    license_plate = CASE 
        ...
        ELSE '51B-' + CAST(vehicle_id AS VARCHAR)
    END,
...
UPDATE vehicles SET 
    image = CASE 
        ...
        ELSE 'https://vinfast3sthanhhoa.com/wp-content/uploads/2023/09/vf6-mau-trang-1-1110x1032-600x600-1.jpg'
    END,
    license_plate = CASE 
        ...
        ELSE '51C-' + CAST(vehicle_id AS VARCHAR)
    END,
...
UPDATE vehicles SET 
    image = CASE 
        ...
        ELSE 'https://vinfastdongthap.vn/wp-content/uploads/2023/09/mau-xe-vinfast-vf7-6.png'
    END,
    license_plate = CASE 
        ...
        ELSE '51D-' + CAST(vehicle_id AS VARCHAR)
    END,
...
UPDATE vehicles SET 
    image = CASE 
        ...
        ELSE 'https://vinfastvietnam.net.vn/uploads/data/3097/files/files/VINFAST%20VFE35/5F1DF5B0-B8ED-45F8-993B-755D9D014FBC.jpeg'
    END,
    license_plate = CASE 
        ...
        ELSE '51E-' + CAST(vehicle_id AS VARCHAR)
    END,
...
UPDATE vehicles SET 
    image = CASE 
        ...
        ELSE 'https://vnvinfast.com/data/upload/media/img-ce1h-1699328361.webp'
    END,
    license_plate = CASE 
        ...
        ELSE '51F-' + CAST(vehicle_id AS VARCHAR)
    END,
